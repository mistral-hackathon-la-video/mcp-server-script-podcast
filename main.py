...
@mcp.tool(
    ...
    description="Generates a video script for a research paper using AI models via OpenRouter",
)
async def generate_script(
    ...
    """Generates a video script for a research paper.
    
    This tool takes research paper content in markdown format and generates
    a structured video script suitable for YouTube content creation.
    
    Args:
        paper_markdown: The research paper content in markdown format
        paper_id: The ArXiv paper ID (e.g., '2405.11273')
        method: The AI method to use (default: 'openrouter')
        from_pdf: Whether the paper comes from PDF extraction
        
    Returns:
        Generated video script as formatted text
